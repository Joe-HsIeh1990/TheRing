  ...
  <div class="bg-dark">
    ...
    <header class="header">
      ...
      <div class="arr d-flex justify-content-center">
        ...
        >
          <div
            class="arr-item1 mx-auto mt-1"
            data-down="title"
          >
            <div
              class="arr-inside mx-auto mt-1"
              data-down="title"
            />
          </div>
          <i
            class="fas fa-chevron-down mx-auto mt-1"
            data-down="title"
          />
        </div>
      </div>
    ...
    <div
      id="hobbit"
      class="new new-container1 py-4 px-0 mt-md-5"
    >
      <div class="new-content d-flex flex-wrap pb-2">
        <div class="col-md-6 col-12 new-photo new-list px-0" />
        <div
        ...
        >
          <div class="new-txt d-flex col-12 flex-column justify-content-center px-0 p-md-3">
            <h3 class="font-weight-bold my-2 px-0 text-warning">
              哈比人歷險記
            </h3>
            <p class="text-white">
              主角比爾博被巫師甘道夫挑上，激發出他冒險的慾望，與十三個矮人組成探險隊，前往有一條惡龍守護的孤山，展開了尋寶之旅。
            </p>
            <p class="text-white">
              這次我們將整個電影縮小成戰棋，使用手上的戰旗陪著比爾博·巴金斯一起經歷這宏偉的史詩戰役。
            </p>
    ...
    <div
      id="ring"
      class="new new-container2 py-4 px-0"
    >
      <div class="new-content d-flex flex-wrap flex-row-reverse">
        <div class="col-md-6 col-12 new-photo2 new-list px-0" />
        <div
          class="new-list new-text col-md-6 col-12 d-flex justify-content-center align-items-center"
        >
          <div class="new-txt d-flex col-12 flex-column justify-content-center px-0 p-md-3">
            ...
            <p class="text-white">
              主角哈比人佛羅多·巴金斯以及魔戒遠征隊所執行的毀掉至尊魔戒任務，以及消滅至尊魔戒的製造者黑暗魔君索倫。
            </p>
            <p class="text-white">
              這次我們將整個電影縮小成戰棋，使用手上的戰旗陪著佛羅多·巴金斯一起經歷這宏偉的史詩戰役。
            </p>
            <router-link to="/custom/detail/-MAA2hhWD2k_3PvrK8oz">
              <div class="d-flex my-2">
                <a
                  href="#"
                  class="btn btn-warning"
    ...
    <section class="section pt-5 mt-5">
      <div class="section-title">
        <h2 class="text-warning mx-auto border-bottom border-warning pb-5 font-weight-bold">
          熱銷商品
        </h2>
      </div>
    ...
    <div
      class="gotop rounded-circle py-1 px-2"
      @click="gotoper"
    >
      <font-awesome-icon
        icon="arrow-up"
